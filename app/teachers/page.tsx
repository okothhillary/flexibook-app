    ...
    <div className="min-h-screen relative">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="mb-8 sm:mb-12">
          <h1
            className="text-3xl sm:text-4xl lg:text-5xl font-black text-gray-900 tracking-tight mb-2 sm:mb-3"
        ...
        <div
          className="mb-6 sm:mb-8 text-sm sm:text-base text-gray-500 flex flex-wrap gap-2 items-center"
          style={{ fontFamily: "'Inter', sans-serif" }}
        >
          <span
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {teachers.map((teacher) => {
              ...
              return (
                <div
                  key={teacher.id}
                  className="backdrop-blur-xl bg-white/80 rounded-3xl shadow-lg border border-gray-200/60 p-6 sm:p-8 hover:shadow-2xl transition-all duration-300 group"
                >
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-5 mb-4 sm:mb-6">
                    <Avatar className="w-16 h-16 sm:w-20 sm:h-20 ring-4 ring-gray-100 group-hover:ring-gray-200 transition-all duration-300">
                      <AvatarImage src={teacher.user.image || undefined} />
                      <AvatarFallback
                        className="text-xl sm:text-2xl font-black bg-gradient-to-br from-gray-800 to-gray-900 text-white"
                        style={{ fontFamily: "'Inter', sans-serif" }}
                      >
                        {initials}
                      </AvatarFallback>
                    ...
                    <div className="flex-1">
                      ...
                      <p
                        className="text-sm sm:text-base text-gray-600 font-semibold flex items-center gap-1"
                        style={{ fontFamily: "'Inter', sans-serif" }}
                      >
                  ...
                  <div className="flex flex-wrap gap-2 mb-4 sm:mb-6">
                    {teacher.languages.slice(0, 3).map((lang: string) => (
                      <span
                        key={lang}
                        className="px-2 sm:px-3 py-1 text-xs sm:text-sm font-bold bg-gray-100 text-gray-800 rounded-full"
                        style={{ fontFamily: "'Inter', sans-serif" }}
                      >
                        {lang}
                      </span>
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-between pt-4 border-t border-gray-200">
                    ...
                    <Link
                      href={`/teachers/${teacher.user.id}/book`}
                      className="w-full sm:w-auto"
                    >
                      <Button className="w-full sm:w-auto bg-gradient-to-r from-gray-800 to-gray-900 hover:from-gray-900 hover:to-black text-white shadow-lg rounded-xl px-4 sm:px-6 py-3 sm:py-4 font-bold transition-all duration-300">
                        Book Lesson
                      </Button>
                    </Link>
                  </div>
